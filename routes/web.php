...
Route::group(['as' => 'auth.', 'middleware' => 'auth'], function () {
    ...
    Route::group(['as' => 'manager.', 'middleware' => ['role:super-admin|manager']], function () {
        ...
        Route::get('questions/assignmentIndex', 'Web\QuestionWebController@assignmentIndex');
        Route::get('questions/acquisitionIndex', 'Web\QuestionWebController@acquisitionIndex');

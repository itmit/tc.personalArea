            ...
            $.ajax({
                ...
                else
                {
                    for(var i = 0; i < data[0].length; i++) {
                        ...
                        result += '<td><div class="place-tools"><i class="material-icons"><a href="place/edit/' + data[0][i]['id'] + '">edit</a></i>';
                        result += '<i class="material-icons"><a href="#" class="js-destroy-ones">close</a></i></div></td>';
